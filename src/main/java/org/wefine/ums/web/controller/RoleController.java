...
public class RoleController {
    ...
    public
    @ResponseBody
    MessageBox getSysRoleList(Pager pager
    ) {
    ...
    public
    @ResponseBody
    MessageBox addRole(SysRoles roles) {
        MessageBox messageBox = new MessageBox();
        if (roles != null) {
    ...
    public
    @ResponseBody
    MessageBox delRole(String roleId) {
        MessageBox messageBox = new MessageBox();
    ...
    @ResponseBody
    public MessageBox getRoleAuthorities(Pager pager,
    ...
    @ResponseBody
    public MessageBox addRoleAuthority(String authIds, String roleId) {
        MessageBox messageBox = new MessageBox();
    ...
    @ResponseBody
    public MessageBox delRoleAuthority(String authIds, String roleId) {
        MessageBox messageBox = new MessageBox();
        if (StringUtil.isNotEmpty(authIds) && StringUtil.isNotEmpty(roleId)) {
