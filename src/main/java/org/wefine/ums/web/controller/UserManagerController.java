...
//    }
    ...
    public
    @ResponseBody
    MessageBox changePassWord(String oldpassword, String newpassword) {
    ...
    public
    @ResponseBody
    MessageBox getUserData(Pager pager
    ) {
        MessageBox messageBox = new MessageBox();
    ...
    public
    @ResponseBody
    MessageBox addUser(SysUsers users) {
        MessageBox messageBox = new MessageBox();
        if (users != null) {
    ...
    public
    @ResponseBody
    MessageBox delUserById(String userid) {
        MessageBox messageBox = new MessageBox();
    ...
    public
    @ResponseBody
    MessageBox addUserRole(String roleIds,
                           String userId) {
        MessageBox messageBox = new MessageBox();
    ...
    public
    @ResponseBody
    MessageBox delUserRole(String roleIds,
                           String userId) {
        MessageBox messageBox = new MessageBox();
        if (StringUtil.isNotEmpty(roleIds) && StringUtil.isNotEmpty(userId)) {
    ...
    public
    @ResponseBody
    MessageBox getuserRole(Pager pager,
    ...
    public
    @ResponseBody
    MessageBox lockUser(@PathVariable("userid") String userid) {
        MessageBox messageBox = new MessageBox();
        if (StringUtil.isNotEmpty(userid)) {
    ...
    public
    @ResponseBody
    MessageBox enableUser(@PathVariable("userid") String userid) {
        MessageBox messageBox = new MessageBox();
        if (StringUtil.isNotEmpty(userid)) {
